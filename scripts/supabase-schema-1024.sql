-- ============================================
-- TatT Pro: Complete Supabase Schema (1024-dim)
-- ============================================
-- Uses 1024-dimensional embeddings (compatible with pgvector limits)
-- 1024 dims is excellent for production embedding search
-- ============================================
...
-- ============================================
-- 5. Create portfolio_embeddings table (1024-dim)
-- ============================================
CREATE TABLE IF NOT EXISTS portfolio_embeddings (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  artist_id UUID NOT NULL,
  embedding VECTOR(1024) NOT NULL,  -- Reduced to 1024 dimensions
...
-- Create HNSW index for vector similarity search (1024 dims works!)
...
-- ============================================
-- 7. Create vector search function (1024-dim)
-- ============================================
CREATE OR REPLACE FUNCTION match_artists(
  query_embedding VECTOR(1024),  -- Changed to 1024 dimensions
...
-- ✅ portfolio_embeddings table (1024-dim vectors)
...
--
-- Next steps:
-- 1. Generate 1024-dim embeddings with Vertex AI
-- 2. Start creating designs via your app
-- 3. Test vector search: SELECT * FROM match_artists('[...]'::vector(1024), 0.7, 10);
-- ============================================
