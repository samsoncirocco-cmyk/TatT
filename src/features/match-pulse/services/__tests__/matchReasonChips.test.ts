        ...
        const chips = deriveReasonChips(
            {
                ...
                rating: 4.8,
                reviewCount: 120,
                portfolio: Array.from({ length: 40 }, (_, i) => `p${i}`),
            },
            { styles: ["Blackwork"], location: "Austin" }
        );
        ...
        const chips = deriveReasonChips(
            {
                ...
                rating: 4.9,
                reviewCount: 87,
                portfolio: Array.from({ length: 12 }, (_, i) => `p${i}`),
            },
