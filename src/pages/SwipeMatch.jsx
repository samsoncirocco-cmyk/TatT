  ...
  if (error) {
    return (
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="text-center max-w-md border-2 border-red-500/10 p-12 rounded-3xl bg-red-50/50">
          ...
          <div className="flex flex-col gap-3">
            <button
              ...
              className="w-full py-4 bg-red-600 text-white font-black rounded-2xl shadow-lg hover:shadow-red-600/20 transition-all uppercase text-[10px] tracking-widest"
            >
              Adjust Biometric Intent
            </button>
            <p className="text-[9px] text-gray-400 font-bold uppercase tracking-widest">
              Try increasing search radius or removing style filters
            </p>
          </div>
        </div>
      </div>
