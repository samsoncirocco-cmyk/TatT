...
import { DesignSessionFlow } from '@/features/design-session';

/**
 * The design-session surface: conversational intake → reveal → one
 * refinement round → handoff (ADR-0009, ADR-0012, ADR-0013). Mobile-first —
 * this is the first screen a TikTok/IG first-timer lands on.
 */
