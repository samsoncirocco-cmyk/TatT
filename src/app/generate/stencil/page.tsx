...
import { artistsUrlForDesign } from "@/lib/design-style-signal";
              ...
              {cuts.length > 0 && (
                <div className="mt-10">
                  ...
                  {/* DESIGN → ARTIST SIGNAL — carries the prompt's style
                      descriptors to the /artists directory as a canonical
                      graph style filter. */}
                  <div className="mt-8 flex flex-col sm:flex-row sm:items-center gap-4 border-t-2 hairline pt-6">
                    <TapeCTA href={artistsUrlForDesign(prompt)} size="lg">
