...
export interface CouncilPrompts {
  simple: string;
  detailed: string;
  ultra: string;
}
...
const COUNCIL_MEMBERS: Record<string, CouncilMemberConfig> = {
  creative: {
...
Return as JSON:
{
  ...
  "ultra": "..."
    ...
    const creativeResult: CouncilPrompts = JSON.parse(creativePrompt);
 ...
 */
export function getEstimatedCost(): EstimatedCost {
