...
export interface FetchJSONOptions extends FetchWithAbortOptions {
 ...
 * @param options - Fetch options with timeout and auth support
 * @returns Fetch response
 * @throws FetchError with structured error data
 */
    ...
    if (!response.ok) {
      ...
      if (contentType && contentType.includes('application/json')) {
        try {
          ...
          errorCode = (errorData.code as ErrorCode) || errorCode;
        } catch (e) {
