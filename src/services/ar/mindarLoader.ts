 ...
 * @returns True if MindAR can be loaded
 */
export async function isMindARSupported(): Promise<boolean> {
 ...
 * @returns MindAR module (or null for fallback)
 */
export async function loadMindAR(): Promise<MindARModule | null> {
 ...
 * @param videoElement - Video element for AR
 * @param options - Session options
 * @returns AR session object
 */
export async function createMindARSession(
  videoElement: HTMLVideoElement,
  options: MindARSessionOptions = {}
): Promise<MindARSession | null> {
